                ...
                <div class="col-lg-12">
                    <div class="menu-lateral">
                        ...
                        <div class="blue-menu">
                            ...
                            <div class="box-select">
                                <select class="form-select" aria-label="Default select example">
                                    <option selected>Encuesta General</option>
                            ...
                            <div class="box-buttons">
                                <a href="#">Encuesta servidores públicos</a>
                        ...
                        <div class="red-menu">
                            ...
                            <div class="box-buttons">
                                <a href="#">Entorno Institucional Paz</a>
                                <a href="#">Entorno Institucional Mujeres</a>
                                <a href="#">Entorno Institucional LGBTIQ</a>
                                <a href="#">Ficha técnica</a>
                            </div>
                        </div>
                        <div class="gray-menu">
